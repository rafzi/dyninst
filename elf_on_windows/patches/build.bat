...
copy libelf.lib libelf_install\lib\libelf.lib
copy libelf.lib libelf_install\lib\libelf.dll
copy libelf.lib libelf_install\lib\libelf.exp
copy libelf.lib libelf_install\lib\libelf.def
copy libelf.h libelf_install\include\libelf\libelf.h
copy sys_elf.h.w32 libelf_install\include\libelf\sys_elf.h
copy elf_repl.h libelf_install\include\libelf\elf_repl.h