...
copy the folder libelf_install from libelfs lib/ directory next to the downloaded dwarf-v/libdwarf folder (not inside)
copy the VC folder from patches/ into the downloaded dwarf-v/libdwarf folder
